...
public class GPSTracker extends Service implements LocationListener {
    ...
    private static final long MIN_TIME_BW_UPDATES = 1000 *5; // 15 seconds

    // Declaring a Location Manager
    protected LocationManager locationManager;
    protected ILocationChange iLocationChange;
    ...
    public void showSettingsAlert() {
        ...
        alertDialog.setMessage("Please turn on the GPS to get current location.Do you want to go to settings menu?");
    ...
    public void onLocationChanged(Location location) {
        Log.d("location gps", "changed");
        if (iLocationChange != null) {
            iLocationChange.locationChanged(location);
        }
    ...
    public void onProviderDisabled(String provider) {
        Log.d("location disabled", "" + provider);
    }
